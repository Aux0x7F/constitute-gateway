...
pub fn gateway_association_posture(
    ...
    let contribution = HostFabricMemberContribution {
        ...
        participant_ref: record.identity_id.clone(),
        ...
        module_refs: vec![
            "module:gateway-association".to_string(),
            format!("adapter:gateway:{}", record.host_platform),
        ],
        source_refs: vec![
            format!("source:gateway:{}", record.service_version),
            format!("release:gateway:{}", record.service_version),
        ],
